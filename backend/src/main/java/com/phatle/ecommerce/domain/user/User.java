...
import com.phatle.ecommerce.domain.inventory.InventoryReceipt;
import com.phatle.ecommerce.domain.order.Cart;
import com.phatle.ecommerce.domain.order.Order;
import com.phatle.ecommerce.domain.product.Review;
...
@AllArgsConstructor
@Builder
public class User extends BaseEntityWithoutAudit {
